/**************************************************************************
**
**		$Source: C:\\RCS\\D\\Pumpkin\\CubeSatKit\\HCC-Embedded\\EFFS-THIN\\src\\csk_effs_thin-1.h,v $
**		$Author: aek $
**		$Revision: 3.3 $
...
**
**  	Settings for CubeSat Kit EFFS-THIN library #1
**
**************************************************************************/

#ifndef CSK_EFFS_THIN_1
#define CSK_EFFS_THIN_1
