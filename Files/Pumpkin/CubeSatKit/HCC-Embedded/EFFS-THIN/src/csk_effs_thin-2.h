/**************************************************************************
**
**		$Source: C:\\RCS\\D\\Pumpkin\\CubeSatKit\\HCC-Embedded\\EFFS-THIN\\src\\csk_effs_thin-2.h,v $
**		$Author: aek $
**		$Revision: 3.3 $
**		$Date: 2011-03-23 21:55:13-08 $
**
**  	FAT thin user settings
**
**  	Settings for CubeSat Kit EFFS-THIN library #2
**
**************************************************************************/

#ifndef CSK_EFFS_THIN_2
#define CSK_EFFS_THIN_2
...
#define F_MAXFILES			2			/*maximum number of files */
