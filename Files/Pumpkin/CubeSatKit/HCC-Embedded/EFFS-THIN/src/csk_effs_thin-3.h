/**************************************************************************
**
**		$Source: C:\\RCS\\D\\Pumpkin\\CubeSatKit\\HCC-Embedded\\EFFS-THIN\\src\\csk_effs_thin-3.h,v $
**		$Author: aek $
**		$Revision: 3.3 $
...
**
**  	Settings for CubeSat Kit EFFS-THIN library #3
**
**************************************************************************/

#ifndef CSK_EFFS_THIN_3
#define CSK_EFFS_THIN_3
