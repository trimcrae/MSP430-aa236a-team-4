...
$Source: C:\\RCS\\D\\Pumpkin\\Library\\MSP430\\Inc\\sw_UART_msg.h,v $
$Author: aek $
$Revision: 3.2 $
...
#ifndef __sw_uart_msg_h
#define __sw_uart_msg_h
...
extern void sw_uart4_msg(const char *);

#endif /* __sw_uart_msg_h */
